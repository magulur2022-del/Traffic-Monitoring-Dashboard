...
import { createTraffic } from "../services/trafficService";
...
const AddTraffic = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await createTraffic(trafficData);
      alert("Traffic record added successfully!");
      navigate("/traffic-records");
    } catch (err) {
      console.error(err);
      setError(
        err?.response?.data?.message || "Failed to add traffic record."
      );
    } finally {
      setLoading(false);
    }
        ...
        <main className="p-6">
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8">
            ...
            <p className="text-gray-500 mb-8">
              Enter the details below to add a new traffic monitoring location.
            </p>
            ...
            >
              ...
              <div className="md:col-span-2 flex justify-end gap-4 mt-6">
                ...
                >
                  {loading ? "Saving..." : "Add Traffic Record"}
                </button>
              </div>
            </form>
          </div>
